...
**Morse Code Ruby** is a wRuby application that allows you to decode morse code messages.
...
You could use this project to see decode morse code messages.
...
- you can clone this repo by typing `git clone https://github.com/enoqueJonas/morse-code-ruby.git`.
- type `cd morse-code-ruby` to access the project on terminal.
